...
# rhythmcache.t.me
ui_print "This Module Is Generated Using Bootanimation-Creator-Script"
if [ -f "/system/product/media/bootanimation.zip" ]; then
    ...
    echo "description=if you are seeing this , it means bootanimation installed at /system/product/media , if it isn't working, report it to @ximistuffschat on TG" >> "$MODPATH/module.prop"
